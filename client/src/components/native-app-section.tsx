...
import { Home, Plus, Zap, Shield, Download } from "lucide-react";
...
export default function NativeAppSection() {
  ...
  return (
    <section id="native-app" className="py-20 bg-gradient-to-r from-cellar-navy to-cellar-navy-light" ref={ref}>
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Add Cellar to your home screen for instant access. Works like a native app without app store downloads.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h3 className="text-2xl font-bold mb-6">Add to Home Screen in 4 Steps</h3>
            
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="w-8 h-8 bg-cellar-cyan rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">1</div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="w-8 h-8 bg-cellar-cyan rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">2</div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="w-8 h-8 bg-cellar-cyan rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">3</div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="w-8 h-8 bg-cellar-cyan rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">4</div>
                <div>
