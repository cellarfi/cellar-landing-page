...
export default function SocialSection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-r from-cellar-navy to-cellar-navy-light relative overflow-hidden" ref={ref}>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Stay ahead of the market with real-time social insights, community-driven token calls, and trending discussions - all integrated seamlessly into your wallet experience.
            </p>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2">Trending Tokens</h3>
                  <p className="text-gray-400">Discover hot tokens before they explode with community-driven insights.</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2">Community Calls</h3>
                  <p className="text-gray-400">Share and receive token calls directly from trusted community members.</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-400">Get real-time updates without endless scrolling on social platforms.</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-400">Latest community insights</div>
                  </div>
                </div>
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center space-x-2">
                          <div className={`w-6 h-6 ${token.color} rounded-full`}></div>
