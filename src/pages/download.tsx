...
export default function DownloadPage() {
  ...
  const handleNotifyMe = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description:
        "We'll email you as soon as Cellar for Android is available.",
    })
    setEmail('')
  }
  ...
  const testimonials = [
    {
      ...
      role: 'DeFi Trader',
      comment:
        "Finally, a wallet that doesn't make me worry about losing my seed phrase!",
      rating: 5,
      avatar:
    ...
    },
    {
      ...
      role: 'NFT Collector',
      comment:
        'Smooth, fast, and secure. Everything I need in a Solana wallet.',
      rating: 5,
      avatar:
        ...
        <div className='grid lg:grid-cols-2 gap-12 items-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8 leading-relaxed'>
              Get the most advanced Solana wallet for Android. Secure, social,
              and seed-phrase free.
            </p>
            ...
            {versions.map((version, index) => (
              ...
              >
                ...
                <div className='space-y-2 mb-4'>
                  <div className='text-sm font-semibold text-cellar-cyan'>
                    What's New:
                  </div>
            ...
            <div className='flex items-start space-x-3'>
              ...
              <div>
                ...
                <ol className='text-gray-300 space-y-2 text-sm'>
                  ...
                  <li>
                    2. Go to Settings → Security → Enable "Unknown Sources" or
                ...
                <p className='text-xs text-gray-400 mt-4'>
                  Note: You may need to temporarily disable Google Play Protect
                  during installation.
                </p>
              </div>
            </div>
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            ...
            >
              ...
              <p className='text-lg text-gray-300 mb-8'>
                Cellar is optimized to run smoothly on most modern Android
                devices.
              </p>
              ...
              <div className='mt-6 p-4 bg-cellar-navy-light rounded-xl'>
                <h4 className='text-sm font-semibold text-cellar-cyan mb-2'>
            ...
            >
              <div className='text-center mb-6'>
                ...
                <p className='text-gray-300'>
                  Built specifically for Android with Material Design principles
        ...
        <div className='container mx-auto px-6'>
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            ...
            >
              ...
              <p className='text-lg text-gray-300 mb-8'>
                Create a native app-like experience by adding Cellar directly to
                your home screen. Access your wallet instantly without opening a
                browser.
              </p>

              <div className='space-y-6'>
                <div className='flex items-start space-x-4'>
                  <div className='w-8 h-8 bg-cellar-cyan rounded-full flex items-center justify-center text-sm font-bold'>
                    1
                  </div>
                  <div>
                    <h4 className='font-semibold mb-2'>Open in Browser</h4>
                    <p className='text-gray-400'>
                      Visit cellarfi.com on your mobile browser
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-400'>
                      Find the share/menu button in your browser
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-400'>
                      Tap the Cellar icon on your home screen anytime
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className='py-20'>
        <div className='container mx-auto px-6 text-center'>
          ...
          >
            ...
            <p className='text-lg text-gray-300 mb-8'>
              Get notified as soon as Cellar for Android is available for
              download.
            </p>
