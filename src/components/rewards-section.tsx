...
export default function RewardsSection() {
  ...
  return (
    <section
      id='rewards'
      className='py-20 bg-gradient-to-r from-cellar-navy-light to-cellar-navy relative overflow-hidden'
      ref={ref}
    >
      {/* Background Elements */}
        ...
        <div className='grid lg:grid-cols-2 gap-16 items-center'>
          ...
          >
            ...
            <h2 className='text-4xl md:text-5xl font-bold mb-6'>
              Earn <span className='gradient-text'>Rewards</span> for Everything
              You Do
            </h2>

            <p className='text-xl text-gray-300 mb-8 leading-relaxed'>
              Every activity on Cellar earns you reward points. From swapping
              tokens to engaging with the community, your participation is
              rewarded and can be redeemed for tokens through our rewards
              program.
            </p>
                ...
                <div className='flex items-center space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-400'>
                      Convert points to CELLAR tokens
                    </p>
                  </div>
                </div>
            ...
            <div className='glass-morphism rounded-3xl p-8 text-center'>
              <div className='mb-6'>
                ...
                <p className='text-gray-400'>
                  Join thousands earning rewards on Cellar
                </p>
              </div>
