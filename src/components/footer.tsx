        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-cellar-cyan transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><button onClick={() => document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' })} className="text-gray-400 hover:text-white transition-colors duration-300">Features</button></li>
              <li><button onClick={() => document.getElementById('download')?.scrollIntoView({ behavior: 'smooth' })} className="text-gray-400 hover:text-white transition-colors duration-300">Download</button></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Bug Report</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Disclaimer</a></li>
            </ul>
          </div>
        </div>
